...
class LogKJob(models.Model):
    ...
    QMTitle = models.CharField(max_length=100, blank=True, default='AQUA-MER Log K Calculation')
    ...
    QMTitleP1 = models.CharField(max_length=100, blank=True, default='AQUA-MER Log K Calculation')
