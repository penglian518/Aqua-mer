...
class QMCalculationPrepare:
    ...
    def gen_conf_dict(self, obj):
        ...
        if obj.Name in ['pka']:
            ...
            conf_L_link1 = self.obj_to_dict_link1(obj=obj)
    ...
    def obj_to_dict(self, obj):
        ...
        if obj.QMCavitySurface in ['Default']:
            ...
            # the 1st step of logk calculation requires the default SMD model
            if obj.Name in ['logk']:
                step1_qm_conf['SCRF_Read'] = False
                step1_qm_conf['SCRF_parameters_nw'] = ''
            else:
    ...
    def obj_to_dict_link1(self, obj):
        if obj.Name in ['pka']:
            complex_name = 'A'
        elif obj.Name in ['logk']:
            complex_name = 'L'
    ...
    def obj_to_dict_HA_link1(self, obj):
    ...
    def obj_to_dict_M_link1(self, obj):
        # prepare for conf_M
        step1_qm_conf = {
            # A group of calculation contains many steps
            'Group_name': '%s_%s' % (obj.Name, obj.JobID),
